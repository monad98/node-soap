    ...
    function Server(server, path, services, wsdl, options) {
        ...
        wsdl.onReady(function (err) {
            if (isExpress(server)) {
                ...
                server.route(path).all(function (req, res) { return __awaiter(_this_1, void 0, void 0, function () {
                    var authorizeResult, result, err_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(typeof this.authorizeConnection === 'function')) return [3 /*break*/, 6];
                                authorizeResult = this.authorizeConnection(req, res);
                                if (!(typeof authorizeResult === 'boolean')) return [3 /*break*/, 1];
                                if (!authorizeResult) {
                                    res.end();
                                    return [2 /*return*/];
                                }
                                return [3 /*break*/, 6];
                            case 1:
                                if (!isPromiseLike(authorizeResult)) return [3 /*break*/, 6];
                                result = false;
                                _a.label = 2;
                            case 2:
                                _a.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, authorizeResult];
                            case 3:
                                result = _a.sent();
                                return [3 /*break*/, 5];
                            case 4:
                ...
                server.addListener('request', function (req, res) { return __awaiter(_this_1, void 0, void 0, function () {
                    var authorizeResult, result, err_2, reqPath, i, len;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(typeof this.authorizeConnection === 'function')) return [3 /*break*/, 6];
                            ...
                            case 6:
                                ...
                                if (path === reqPath || (path instanceof RegExp && reqPath.match(path))) {
                                    ...
                                    for (i = 0, len = listeners_1.length; i < len; i++) {
                                        listeners_1[i].call(this, req, res);
                                    }
                                }
                                return [2 /*return*/];
                        }
